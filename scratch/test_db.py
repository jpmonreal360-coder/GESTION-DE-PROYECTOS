...
payload = {
    ...
    "documents": [
        { "id": "pdoc-1", "title": "Contrato Marco de Desarrollo & NDA v1.2", "format": "pdf", "docType": "PDF", "typeLabel": "Contrato PDF", "projectId": "PRJ-01", "date": "2026-08-01", "updatedAt": "2026-08-01", "fileUrl": "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf", "description": "Documento legal en formato PDF firmado con acuerdo de confidencialidad." },
        { "id": "pdoc-2", "title": "Foto / Captura de Maqueta UI Aprobada", "format": "image", "docType": "IMAGE", "typeLabel": "Foto / Imagen", "projectId": "PRJ-01", "date": "2026-08-12", "updatedAt": "2026-08-12", "previewUrl": "https://images.unsplash.com/photo-1616469829941-c7200edec809?w=800&auto=format&fit=crop&q=80", "fileUrl": "https://images.unsplash.com/photo-1616469829941-c7200edec809?w=1600&auto=format&fit=crop&q=80", "description": "Fotografía / Render en alta resolución del diseño UI/UX validado por el cliente." }
    ],
    "wikiDocs": [
        { "id": "doc-1", "title": "Guía de Estilo UI/UX - Apple Human Interface Guidelines", "projectId": "PRJ-01", "updatedAt": "2026-08-19", "content": "### Principios de Diseño\n1. Translucidez y Vidrio Esmerilado\n2. Jerarquía Tipográfica" }
    ],
    "categories": ["Facturación / Cobro", "Software & Cloud", "Diseño UI/UX", "Desarrollo Frontend/Backend", "Infraestructura & Server", "Marketing & Ads"],
    "projectCategories": ["Mobile App", "Web App", "Design", "Infrastructure", "Marketing"]
}

req = urllib.request.Request("https://jsonblob.com/api/jsonBlob", data=json.dumps(payload).encode('utf-8'), headers={"Content-Type": "application/json", "Accept": "application/json"}, method="POST")
