import { parseImportText, normalizeAmount, normalizeDate } from '../src/lib/parseImportText';
...
console.log('Filas válidas:', result.validRows.length, result.validRows);
console.log('Filas inválidas:', result.invalidRows.length, result.invalidRows);
